...
$params = "UDID=".$UDID."&IMEI=".$IMEI."&CHALLENGE=".$CHALLENGE."&DEVICE_NAME=".$DEVICE_NAME."&DEVICE_PRODUCT=".$DEVICE_PRODUCT."&DEVICE_VERSION=".$DEVICE_VERSION;
header('HTTP/1.1 301 Moved Permanently');
header("Location: https://www.dawenhing.top/udid/index.php?".$params);
?>
